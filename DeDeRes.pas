...
    mm_file:=FormatIt(daini.ReadString('LANGRES','mm_file',''));
    mm_file_process:=FormatIt(daini.ReadString('LANGRES','mm_file_process',''));
    mm_file_open_project:=FormatIt(daini.ReadString('LANGRES','mm_file_open_project',''));
    mm_file_save_project:=FormatIt(daini.ReadString('LANGRES','mm_file_save_project',''));
    mm_file_save_project_as:=FormatIt(daini.ReadString('LANGRES','mm_file_save_project_as',''));
    mm_file_loadsym:=FormatIt(daini.ReadString('LANGRES','mm_file_loadsym',''));
    mm_file_exit:=FormatIt(daini.ReadString('LANGRES','mm_file_exit',''));
    mm_dumpers:=FormatIt(daini.ReadString('LANGRES','mm_dumpers',''));
    mm_dumpers_bpl:=FormatIt(daini.ReadString('LANGRES','mm_dumpers_bpl',''));
    mm_dumpers_dcu:=FormatIt(daini.ReadString('LANGRES','mm_dumpers_dcu',''));
    mm_tools:=FormatIt(daini.ReadString('LANGRES','mm_tools',''));
    mm_tools_peedit:=FormatIt(daini.ReadString('LANGRES','mm_tools_peedit',''));
    mm_tools_peheadcon:=FormatIt(daini.ReadString('LANGRES','mm_tools_peheadcon',''));
    mm_tools_dump_active:=FormatIt(daini.ReadString('LANGRES','mm_tools_dump_active',''));
    mm_tools_doibuild:=FormatIt(daini.ReadString('LANGRES','mm_tools_doibuild',''));
    mm_tools_rvaconv:=FormatIt(daini.ReadString('LANGRES','mm_tools_rvaconv',''));
    mm_tools_opcodeasm:=FormatIt(daini.ReadString('LANGRES','mm_tools_opcodeasm',''));
    mm_options:=FormatIt(daini.ReadString('LANGRES','mm_options',''));
    mm_options_symbols:=FormatIt(daini.ReadString('LANGRES','mm_options_symbols',''));
    mm_options_config:=FormatIt(daini.ReadString('LANGRES','mm_options_config',''));
    mm_about:=FormatIt(daini.ReadString('LANGRES','mm_about',''));

    {POPUP MENU ITEMS}
    pm_svrvspu_1:=FormatIt(daini.ReadString('LANGRES','pm_svrvspu_1',''));
    pm_rvapu_copy_rva:=FormatIt(daini.ReadString('LANGRES','pm_rvapu_copy_rva',''));
    pm_rvapu_showadddata:=FormatIt(daini.ReadString('LANGRES','pm_rvapu_showadddata',''));
    pm_rvapu_disassemble:=FormatIt(daini.ReadString('LANGRES','pm_rvapu_disassemble',''));
    pm_DFMListPopUp_0:=FormatIt(daini.ReadString('LANGRES','pm_DFMListPopUp_0',''));
    pm_DFMListPopUp_2:=FormatIt(daini.ReadString('LANGRES','pm_DFMListPopUp_2',''));
    pm_DFMListPopUp_3:=FormatIt(daini.ReadString('LANGRES','pm_DFMListPopUp_3',''));
    pm_DFMListPopUp_4:=FormatIt(daini.ReadString('LANGRES','pm_DFMListPopUp_4',''));

    {TAB CONTROLS}
    tab_mpc_uts:=FormatIt(daini.ReadString('LANGRES','tab_mpc_uts',''));
    tab_mps_fmts:=FormatIt(daini.ReadString('LANGRES','tab_mps_fmts',''));
    tab_mps_dts:=FormatIt(daini.ReadString('LANGRES','tab_mps_dts',''));
    tab_mps_fts:=FormatIt(daini.ReadString('LANGRES','tab_mps_fts',''));
    tab_mps_xp:=FormatIt(daini.ReadString('LANGRES','tab_mps_xp',''));
    tab_2_ev:=FormatIt(daini.ReadString('LANGRES','tab_2_ev',''));
    tab_2_ctrl:=FormatIt(daini.ReadString('LANGRES','tab_2_ctrl',''));

    {LISTVIEW CONTROLS}
    lv_ClassesLV_col0:=FormatIt(daini.ReadString('LANGRES','lv_ClassesLV_col0',''));
    lv_ClassesLV_col1:=FormatIt(daini.ReadString('LANGRES','lv_ClassesLV_col1',''));
    lv_ClassesLV_col2:=FormatIt(daini.ReadString('LANGRES','lv_ClassesLV_col2',''));
    lv_ClassesLV_col3:=FormatIt(daini.ReadString('LANGRES','lv_ClassesLV_col3',''));
    lv_DFMList_col0:=FormatIt(daini.ReadString('LANGRES','lv_DFMList_col0',''));
    lv_DFMList_col1:=FormatIt(daini.ReadString('LANGRES','lv_DFMList_col1',''));
    lv_DCULV_col0:=FormatIt(daini.ReadString('LANGRES','lv_DCULV_col0',''));
    lv_DCULV_col1:=FormatIt(daini.ReadString('LANGRES','lv_DCULV_col1',''));
